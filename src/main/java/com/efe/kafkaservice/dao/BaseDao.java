...
public interface BaseDao<T> {
	...
	public List<T> getListPage(T entity,RowBounds rowBounds) throws DataAccessException;
    ...
    public List<T> getListByMapPage(Map<String, Object> params,RowBounds rowBounds);
    
    public List<T> getListByMap(Map<String, Object> params);
	
	public Long CountbyMap(Map<String, Object> params);
	
	public List<T> getListByListPage(List<T> list,RowBounds rowBounds) throws DataAccessException;
	...
	public void batcheditbyMap(Map<String, Object> params) throws DataAccessException;	
